...
internal sealed class ConfigurationManagerAttributes
{
    ...
    ///     Note: Make sure to focus on your UI control when you are accepting EFTInput so user doesn't type in the search box
    ///     or in another setting (best to do this on every frame).
    ...
    /// <summary>
    ///     Force the setting value to not be displayed. Should only be used with a <see cref="CustomDrawer" /> to get more
    ///     space.
